                ...
                <div className="container-custom relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <div className="bg-white/5 backdrop-blur-sm rounded-[2.5rem] overflow-hidden border border-white/10 hover:border-[#86efac]/30 transition-all duration-500 group">
                            ...
                            <div className="p-10 md:p-12">
                                <h3 className="text-3xl font-display font-bold mb-4 text-white">Cabaña Rústica</h3>
                                <p className="text-white/60 mb-8 leading-relaxed font-light">
                                    Construcción tradicional, chimenea, hamaca, baño con vista al bosque. La esencia de San Martín en una experiencia de desconexión total.
                                </p>
                                <div className="flex items-center justify-between mb-8">
                                    <span className="text-4xl font-bold text-[#86efac]">S/ 320<span className="text-sm font-light text-white/40 ml-2">/ noche</span></span>
                                </div>
                                <Link href="https://wa.me/51928141669?text=Hola,%20quiero%20reservar%20la%20Cabaña%20Rústica"
                                    className="block text-center border border-[#86efac]/50 bg-[#86efac]/10 hover:bg-[#86efac] text-[#86efac] hover:text-[#050805] py-5 rounded-2xl font-bold uppercase tracking-widest transition-all duration-500">
                                    Reservar Ahora
                                </Link>
                            </div>
            ...
            <section className="py-24 bg-[#050805] border-t border-white/5 relative overflow-hidden">
                <div className="container-custom relative z-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10">
                        {[
                            { icon: '🍽️', title: 'Gastronomía', desc: 'Desayuno gourmet regional' },
                            { icon: '🧘', title: 'Bienestar', desc: 'Yoga y meditación' },
                            { icon: '🌿', title: 'Naturaleza', desc: 'Tours guiados por la huerta' },
                            { icon: '💆', title: 'Relajación', desc: 'Spa y masajes amazónicos' },
                        ].map((amenidad, index) => (
                ...
                <div className="container-custom relative z-10">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        <div className="bg-gradient-to-br from-white/10 to-transparent border border-white/10 rounded-[2.5rem] p-10 hover:border-[#86efac]/30 transition-all duration-500">
                            <h3 className="text-2xl font-display font-bold mb-4 text-white">Escapada Romántica</h3>
                            <p className="text-white/50 mb-8 font-light">2 noches + cena romántica + masaje de pareja + tour privado por el mariposario.</p>
                            <div className="text-4xl font-bold text-[#86efac] mb-8">S/ 1,200</div>
                            <Link href="https://wa.me/51928141669?text=Hola,%20quiero%20información%20sobre%20el%20Paquete%20Romántico" className="block text-center border border-white/20 bg-white/5 hover:bg-white text-white hover:text-[#050805] py-4 rounded-xl font-bold transition-all duration-500">Consultar</Link>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-[#86efac]/10 to-transparent border border-[#86efac]/30 rounded-[2.5rem] p-10 relative overflow-hidden transform lg:-translate-y-4 shadow-2xl shadow-[#86efac]/10">
                            ...
                            <p className="text-white/50 mb-8 font-light">3 noches + yoga diario + spa + alimentación orgánica completa y meditación guiada.</p>
                            <div className="text-4xl font-bold text-[#86efac] mb-8">S/ 1,650</div>
                            <Link href="https://wa.me/51928141669?text=Hola,%20quiero%20información%20sobre%20el%20Retiro%20de%20Bienestar" className="block text-center bg-[#86efac] text-[#050805] py-4 rounded-xl font-bold hover:scale-[1.02] transition-all duration-500">Reservar Ahora</Link>
                        </div>

                        <div className="bg-gradient-to-br from-white/10 to-transparent border border-white/10 rounded-[2.5rem] p-10 hover:border-[#86efac]/30 transition-all duration-500">
                            <h3 className="text-2xl font-display font-bold mb-4 text-white">Aventura Familiar</h3>
                            <p className="text-white/50 mb-8 font-light">4 noches + actividades para niños + tours guiados por la selva y fogata nocturna.</p>
                            <div className="text-4xl font-bold text-[#86efac] mb-8">S/ 2,100</div>
                            <Link href="https://wa.me/51928141669?text=Hola,%20quiero%20información%20sobre%20el%20Paquete%20Familiar" className="block text-center border border-white/20 bg-white/5 hover:bg-white text-white hover:text-[#050805] py-4 rounded-xl font-bold transition-all duration-500">Consultar</Link>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="reservar" className="py-32 bg-[#050805] relative overflow-hidden">
                ...
                <div className="container-custom relative z-10 text-center">
                    <h2 className="text-5xl md:text-8xl font-display font-black mb-10 text-white tracking-tighter">
                        ¿LISTO PARA <br />
                        <span className="text-[#86efac]">EL PARAÍSO?</span>
                    </h2>
                    <p className="text-xl text-white/50 mb-16 max-w-2xl mx-auto font-light leading-relaxed">
                        Desconéctate del mundo y reconéctate contigo mismo en el corazón de la selva. Cupos limitados para una experiencia exclusiva.
                    </p>
