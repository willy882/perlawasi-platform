...
export default function PlantasPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FBFDFB] text-gray-900">
            ...
            {/* ══ FEATURE CARDS — estilo glassmorphism de la referencia ══════════ */}
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            },
                            {
                                ...
                                desc: 'En Perlawasi usamos compost artesanal y abonos naturales locales. Fertiliza solo en primavera y verano (etapa de crecimiento). En otoño e invierno, las plantas descansan y neocsitan menos nutrientes.',
                                wave: '〰️',
                            },
                        ].map((card, i) => (
                            <div
