    ...
    return (
        <div className="space-y-8 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button onClick={() => setShowModal(true)} className="flex items-center gap-2 px-6 py-3.5 bg-indigo-900 text-white rounded-2xl font-bold text-sm shadow-xl shadow-indigo-900/20 hover:bg-black transition-all">
                    <FiPlus /> Nuevo Licor
                </button>
            </div>
